...
import buddhika from '../images/buddhika-cartoon.png'
...
const Hero = () => {
    ...
    return (
        <div className="relative h-[calc(100vh-20rem)] min-h-[500px] flex justify-center items-center font-black text-3xl">
            ...
            <div className="container flex flex-col sm:flex-row text-white z-10">
                <div className='text-center sm:text-left px-5 sm:px-10 w-full xl:w-4/6'>
