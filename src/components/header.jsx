...
import buddhika from '../images/buddhika.png'
      ...
      <div className="container relative flex justify-between mx-auto px-5 lg:px-0 sm:px-0 py-5 text-base text-white">
        ...
        <div className="flex gap-3 justify-center items-center">
          <div className="w-10 h-10 ">
            <img className="w-full h-full bg-blue-400 rounded-full" src={buddhika} alt="buddhika"   />
          </div>
          <div className="font-['Comfortaa'] text-xl font-bold ">buddhika</div>
        </div>
